...
void ViewLayer::render()
{
	...
	this->m_spriteFont->DrawString(this->m_spriteBatch.get(), this->m_fpsString.c_str(), DirectX::XMFLOAT2(this->m_options->width - 100, 0), DirectX::Colors::White, 0.f, DirectX::XMFLOAT2(0.f, 0.f));
