...
void FindGemsRoom::update(float dt, Camera* camera, Room*& activeRoom, bool& activeRoomChanged)
{
	...
	{
		this->m_Gems[0]->setPosition(this->m_player->getPosition() + (DirectX::XMVectorSet(0, -100, 0, 0)));
		this->m_Gems[0]->setBoundingBox(DirectX::XMFLOAT3(0.f, 0.f, 0.f));
		this->m_Gems[0]->toggleActivateLever();
	...
	{
		this->m_Gems[1]->setPosition(this->m_player->getPosition() + (DirectX::XMVectorSet(0, -100, 0, 0)));
		this->m_Gems[1]->setBoundingBox(DirectX::XMFLOAT3(0.f, 0.f, 0.f));
		this->m_Gems[1]->toggleActivateLever();
		this->m_holdingGem = true;
		this->m_gemInPlace = 2;
	}
	...
	{
		this->m_Gems[2]->setPosition(this->m_player->getPosition() + (DirectX::XMVectorSet(0, -100, 0, 0)));
		this->m_Gems[2]->setBoundingBox(DirectX::XMFLOAT3(0.f, 0.f, 0.f));
		this->m_Gems[2]->toggleActivateLever();
		this->m_holdingGem = true;
		this->m_gemInPlace = 3;
	}
	...
	{
		this->m_Gems[3]->setPosition(this->m_player->getPosition() + (DirectX::XMVectorSet(0, -100, 0, 0)));
		this->m_Gems[3]->setBoundingBox(DirectX::XMFLOAT3(0.f, 0.f, 0.f));
		this->m_Gems[3]->toggleActivateLever();
		this->m_holdingGem = true;
		this->m_gemInPlace = 4;
	}
	...
	{
		this->m_Gems[4]->setPosition(this->m_player->getPosition() + (DirectX::XMVectorSet(0, -100, 0, 0)));
		this->m_Gems[4]->setBoundingBox(DirectX::XMFLOAT3(0.f, 0.f, 0.f));
		this->m_Gems[4]->toggleActivateLever();
		this->m_holdingGem = true;
		this->m_gemInPlace = 5;
	}
	...
	{
		//this->m_Lever[0]->getMoveCompPtr()->rotation = this->m_Lever[0]->getMoveCompPtr()->rotation + DirectX::XMVectorSet(0, 0, 2 * dt, 0);
	...
	{
		if (XMVectorGetY(this->gatePos) <= 20.f)
		{
